...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=908382402ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pegasus_socks&table=salary_disburse">`pegasus_socks`.`salary_disburse`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pegasus_socks&table=employee_salary">`pegasus_socks`.`employee_salary`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pegasus_socks&table=employee_list">`pegasus_socks`.`employee_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=pegasus_socks&table=users">`pegasus_socks`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vsl_website&table=contacts">`vsl_website`.`contacts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vsl_website&table=users">`vsl_website`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=study_laravel&table=users">`study_laravel`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=laravel_rest_api&table=users">`laravel_rest_api`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vsl_website&table=client_logos">`vsl_website`.`client_logos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vsl_website&table=features">`vsl_website`.`features`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4640673a716d4a342a516b396d312848">
