                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-10">
                        ...
                        <div class="card card-info" style="margin-top: 70px;">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" action="{{ route('service.update', $serviceEdit->id) }}"
