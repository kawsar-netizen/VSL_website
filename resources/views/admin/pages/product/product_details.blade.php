                                    ...
                                    <div class="col-lg-4">
                                        <div class="portfolio-details-slider swiper">
                                            <div class="swiper-wrapper align-items-center">
                                                <img class="img-fluid" src="{{ asset('uploads/product/' . $productShow->image) }}"alt="Thumbnail Image"style="border-radius: 3px;">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-8">
                                        <div style="padding: 0 10px">  
                                            <div class="portfolio-info">
                                                ...
                                                <ul>
                                                    <li>
                                                        <strong>Category Name</strong>: {{ $productShow->category->cat_name }}
                                                    </li>
                                                    <li>
                            ...
                            <div class="card-body">
                                <div class="row gy-4">
                                    ...
                                    @foreach ($imges as $imge)
                                        <div class="col-md-3"> 
                                            <img class="img-fluid" src="{{ asset($imge->image) }}"alt="Thumbnail Image"style="border-radius: 3px;"> 
                                        </div>
                                    @endforeach
                                </div>
                            </div>
