                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-info" style="margin-top: 70px;">
                            ...
                            <form class="form-horizontal"
                                action="{{ route('clientTestimonial.update', $clientTestimonianlEdit->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="client_name" id="client_name"
                                                value="{{ $clientTestimonianlEdit->client_name }}">
                                            @error('client_name')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="designation" id="designation"
                                                value="{{ $clientTestimonianlEdit->designation }}">
                                            @error('designation')
                                                <span class="text-danger">
                                                    {{ $message }}
                                                </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="file" class="form-control" name="client_image" id="client_image"
                                                value="{{ $clientTestimonianlEdit->client_image }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="rating" required="required">
                                                <option value="1"
                                                    {{ $clientTestimonianlEdit->rating == 1 ? 'selected' : '' }}>1
                                                </option>
                                                <option value="2"
                                                    {{ $clientTestimonianlEdit->rating == 2 ? 'selected' : '' }}>2
                                                </option>
                                                <option value="3"
                                                    {{ $clientTestimonianlEdit->rating == 3 ? 'selected' : '' }}>3
                                                </option>
                                                <option value="4"
                                                    {{ $clientTestimonianlEdit->rating == 4 ? 'selected' : '' }}>4
                                                </option>
                                                <option value="5"
                                                    {{ $clientTestimonianlEdit->rating == 5 ? 'selected' : '' }}>5
                                                </option>
                                            </select>
                                            @error('rating')
                                                <span class="text-danger">
                                        ...
                                        <div class="col-sm-8" style="margin-top: 10px;">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="active" type="radio" name="status"
                                                    value="1"
                                                    {{ $clientTestimonianlEdit->status == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="active">Active</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" id="deactive" type="radio" name="status"
                                                    value="0"
                                                    {{ $clientTestimonianlEdit->status == '0' ? 'checked' : '' }}>
