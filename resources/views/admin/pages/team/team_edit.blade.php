                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-10">
                        ...
                        <div class="card card-info" style="margin-top: 70px;">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" action="{{ route('team.update', $teamEdit->id) }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label">Employee
                                            Designation</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="emp_designation"
                                                id="emp_designation" value="{{ $teamEdit->emp_designation }}">
